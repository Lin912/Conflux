...
# 绘制中心点
ax.plot3D(Xc, Yc, Zc, linestyle=":", color="#B3112F", linewidth=1.2)

# 图形设置
ax.set_xlim([-50, 2])
ax.set_ylim([-0.1, 0.11])
ax.set_zlim([-0.1, 0.11])

ax.set_xticks(range(-50, 2, 5))
ax.set_yticks(np.arange(-0.1, 0.11, 0.02))
ax.set_zticks(np.arange(-0.1, 0.11, 0.02))
